...
struct ServerIssues;
pub(super) type Issues = (String, String, i64, String, String);
...
struct ServerPulls;
pub(super) type Pulls = (String, String, i64, String, Vec<String>, Vec<String>);
...
pub(crate) trait QueryIssue: Component + Common {
